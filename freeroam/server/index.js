...
alt.onClient('windowUp', player => {
  player.vehicle.setWindowOpened(player.seat-1, false);
});
alt.onClient('windowDown', player => {
  player.vehicle.setWindowOpened(player.seat-1, true);
});
